...
const featuresData = [
  ...
  },
  {
    ...
    link: "/search/search-result?search_query=Video Visits",
    icon: IconBrandZoom,
    disabled: true,
  },
  {
    ...
    link: "/search/search-result?search_query=Lab testing",
    icon: IconTestPipe,
    disabled: true,
  },
  {
    ...
    link: "/search/search-result?search_query=Mental Health",
    icon: IconMoodSick,
    disabled: true,
  },
];
